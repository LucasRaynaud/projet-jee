...
public class Compte {
	...
	@OneToMany(mappedBy = "envoyeur", cascade = CascadeType.REMOVE)
	private List<DemandeAmi> demandeAmi1;
	
	@OneToMany(mappedBy = "receveur", cascade = CascadeType.REMOVE)
	private List<DemandeAmi> demandeAmi2;
